...
GLOBAL_LIST_INIT(ROLES_SPECIAL, list(JOB_PROVOST_ADVISOR))

//Groundside roles
GLOBAL_LIST_INIT(ROLES_XENO, list(JOB_XENOMORPH_QUEEN, JOB_XENOMORPH))
GLOBAL_LIST_INIT(ROLES_GROUND_WHITELISTED, list(JOB_SYNTH_SURVIVOR, JOB_CO_SURVIVOR, JOB_PREDATOR))
GLOBAL_LIST_INIT(ROLES_GROUND, list(JOB_SURVIVOR))

GLOBAL_LIST_INIT(ROLES_USCM, ROLES_CIC + GLOB.ROLES_POLICE + GLOB.ROLES_AUXIL_SUPPORT + GLOB.ROLES_MISC + GLOB.ROLES_ENGINEERING + GLOB.ROLES_REQUISITION + GLOB.ROLES_MEDICAL + GLOB.ROLES_MARINES + GLOB.ROLES_SPECIAL - ROLES_WO)
GLOBAL_LIST_INIT(ROLES_ALL_GROUND, GLOB.ROLES_XENO + ROLES_GROUND + ROLES_GROUND_WHITELISTED)

GLOBAL_LIST_INIT(ROLES_DISTRESS_SIGNAL, GLOB.ROLES_USCM + GLOB.ROLES_ALL_GROUND)
