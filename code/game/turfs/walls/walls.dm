/turf/closed/wall
	...
	var/list/noblend_objects = list(/obj/structure/machinery/door/window, /obj/structure/machinery/door/poddoor/railing) //Objects to avoid blending with (such as children of listed blend objects.
