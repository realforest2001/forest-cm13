...
/obj/item/device/portable_vendor/antag/cia
	...
	listed_products = list(
		...
		list("UACQS Inspection Form", 1, /obj/item/paper/prefab/uacqs/inspection, "white", "A pre-prepared form for departmental inspections."),
...
/obj/item/device/portable_vendor/antag/cia/uacqs_sec
	name = "Automated Storage Briefcase"
	desc = "A briefcase able to dispense items at the user's discretion. This one appears to be tightly locked, and impenetrable."
	points = 200
	max_points = 300
	...
	listed_products = list(
		...
		list("M4A3 HP Magazine", 5, /obj/item/ammo_magazine/pistol/hp, "red", "A hollowpoint magazine for a M4A3 or M4A4 pistol."),
		list("Tranquilizer Magazine", 5, /obj/item/ammo_magazine/pistol/tranq, "blue", "A magazine for a tranquilizer pistol."),
		list("MP5 Magazine", 7, /obj/item/ammo_magazine/smg/mp5, "red", "A magazine for an MP5."),
		list("MP5 AP Magazine", 9, /obj/item/ammo_magazine/smg/mp5/ap, "red", "An AP magazine for an MP5."),
...
/obj/item/device/portable_vendor/antag/cia/uacqs_sec/low_points
	points = 75
